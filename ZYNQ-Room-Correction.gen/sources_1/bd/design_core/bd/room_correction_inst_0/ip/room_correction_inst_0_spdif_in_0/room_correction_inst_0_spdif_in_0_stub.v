...
// Date        : Mon Sep 22 20:45:25 2025
// Host        : VICTUS-01 running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top room_correction_inst_0_spdif_in_0 -prefix
//               room_correction_inst_0_spdif_in_0_ design_core_spdif_0_0_stub.v
// Design      : design_core_spdif_0_0
...
(* CHECK_LICENSE_TYPE = "design_core_spdif_0_0,spdif_top,{}" *) (* core_generation_info = "design_core_spdif_0_0,spdif_top,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=spdif,x_ipVersion=2.0,x_ipCoreRevision=32,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,c_component_name=design_core_spdif_0_0,C_FAMILY=zynq,c_transmit_receive=0,c_axis_buffer_size=1024,c_s_axi_addr_width=9,c_s_axi_data_width=32,c_axis_tdata_width=32,c_axis_tid_width=5,c_cstatus_reg=1,c_userdata_reg=1,c_sample_change=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "spdif_top,Vivado 2025.1" *) 
module room_correction_inst_0_spdif_in_0(aud_clk_i, spdif_interrupt, s_axi_aclk, 
  ...
  s_axi_arvalid, s_axi_arready, s_axi_rdata, s_axi_rresp, s_axi_rvalid, s_axi_rready, spdif_i, 
  m_axis_aclk, m_axis_aresetn, m_axis_tvalid, m_axis_tready, m_axis_tdata, m_axis_tid, 
  rxclk_out)
/* synthesis syn_black_box black_box_pad_pin="spdif_interrupt,s_axi_aresetn,s_axi_awaddr[8:0],s_axi_awvalid,s_axi_awready,s_axi_wdata[31:0],s_axi_wstrb[3:0],s_axi_wvalid,s_axi_wready,s_axi_bresp[1:0],s_axi_bvalid,s_axi_bready,s_axi_araddr[8:0],s_axi_arvalid,s_axi_arready,s_axi_rdata[31:0],s_axi_rresp[1:0],s_axi_rvalid,s_axi_rready,spdif_i,m_axis_aresetn,m_axis_tvalid,m_axis_tready,m_axis_tdata[31:0],m_axis_tid[4:0],rxclk_out" */
/* synthesis syn_force_seq_prim="aud_clk_i" */
/* synthesis syn_force_seq_prim="s_axi_aclk" */
/* synthesis syn_force_seq_prim="m_axis_aclk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 AUDIO_CLK CLK" *) (* x_interface_mode = "slave AUDIO_CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME AUDIO_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_core_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input aud_clk_i /* synthesis syn_isclock = 1 */;
  ...
  (* x_interface_info = "xilinx.com:interface:spdif:2.0 SPDIF_RX SPDIF" *) (* x_interface_mode = "slave SPDIF_RX" *) input spdif_i;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 M_AXIS_ACLK CLK" *) (* x_interface_mode = "slave M_AXIS_ACLK" *) (* x_interface_parameter = "XIL_INTERFACENAME M_AXIS_ACLK, ASSOCIATED_BUSIF M_AXISTREAM, ASSOCIATED_RESET m_axis_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input m_axis_aclk /* synthesis syn_isclock = 1 */;
  (* x_interface_info = "xilinx.com:signal:reset:1.0 M_AXIS_ARESETN RST" *) (* x_interface_mode = "slave M_AXIS_ARESETN" *) (* x_interface_parameter = "XIL_INTERFACENAME M_AXIS_ARESETN, POLARITY ACTIVE_LOW, INSERT_VIP 0" *) input m_axis_aresetn;
  (* x_interface_info = "xilinx.com:interface:axis:1.0 M_AXISTREAM TVALID" *) (* x_interface_mode = "master M_AXISTREAM" *) (* x_interface_parameter = "XIL_INTERFACENAME M_AXISTREAM, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 5, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0" *) output m_axis_tvalid;
  (* x_interface_info = "xilinx.com:interface:axis:1.0 M_AXISTREAM TREADY" *) input m_axis_tready;
  (* x_interface_info = "xilinx.com:interface:axis:1.0 M_AXISTREAM TDATA" *) output [31:0]m_axis_tdata;
  (* x_interface_info = "xilinx.com:interface:axis:1.0 M_AXISTREAM TID" *) output [4:0]m_axis_tid;
  output rxclk_out;
endmodule
